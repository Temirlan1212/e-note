import { LocalizationProvider, DateTimePicker as MUIDateTimePicker, DateTimePickerProps } from "@mui/x-date-pickers";
...
interface IDateTimeProps<T = Date | null> extends Omit<DateTimePickerProps<T>, "onChange" | "value"> {
  onChange?: Function;
  value?: T;
  placeholder?: string;
